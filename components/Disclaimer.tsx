...
interface DisclaimerProps { message: string; }

const Disclaimer: React.FC<DisclaimerProps> = ({ message }) => {
  return (
    <div className="mb-6 p-4 bg-[#fef7e0] border border-[#fbd462] rounded-lg flex gap-4 items-start">
      <div className="flex-shrink-0 text-[#ea8600]">
